...
export const addLocationTitle = 'Добавить город';
...
export const inch = 'Дюйм';
export const gb = 'Гб';
export const whoAdded = 'Кто добавил';
export const addedBy = 'Добавил(а)';
export const updatedBy = 'Обновил(а)';
