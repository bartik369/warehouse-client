        ...
        {device.warranty?.startWarrantyDate ? (
          <>
            <div className={styles.block}>
              <div
                className={`${styles.status} ${!device.warranty?.isExpired ? styles.active : ''}`}
              >
            ...
            <div className={styles.property}>
              ...
              <div className={styles.value}>
                <Link to="#">{device.warranty?.contractor?.name}</Link>
              </div>
            </div>
            ...
            <div className={styles.property}>
              ...
              <div className={styles.value}>
                {device.warranty?.startWarrantyDate &&
                  new Date(device.warranty?.startWarrantyDate).toLocaleDateString('ru-RU')}
              </div>
            </div>
            <div className={styles.property}>
              ...
              <div className={styles.value}>
                {device.warranty?.endWarrantyDate &&
                  new Date(device.warranty?.endWarrantyDate).toLocaleDateString('ru-RU')}
              </div>
            </div>
          </>
        ) : (
