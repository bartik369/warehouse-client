...
import { resetError, resetUser, setChecked, setError, updateUser } from '@/store/slices/userSlice';
...
export const useUser = () => {
  ...
  const handleInputChange = useCallback(<T extends string | User>(field: keyof User, value: T) => {
